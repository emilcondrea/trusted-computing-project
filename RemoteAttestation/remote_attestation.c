...
//*****************************************************************************************************************************//
	...
	if ((result = UnloadBlob_TSS_KEY((UINT16*)&offset, keyData, &keyContainer))){
	...
	offset = 0;
	Trspi_LoadBlob_TCPA_VERSION((UINT16*)&offset, tpmVersion, keyContainer.ver);
